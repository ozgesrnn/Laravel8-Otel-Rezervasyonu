       ...
       <form role="form" action="{{route('admin_hotel_update', ['id' => $data->id ])}}" method="post">
               ...
               <div class="card-body">
                   ...
                   <div class="form-group">
                       ...
                       <input type="number" name="phone" value="{{$data->phone}}" class="form-control" id="exampleInputPassword1" >
                   </div>
                   <div class="form-group">
                   ...
                   <div class="form-group">
                       ...
                       <textarea id="summernote" name="detail" class="form-control" rows="4">{{$data->detail}}</textarea>
                       <script>
