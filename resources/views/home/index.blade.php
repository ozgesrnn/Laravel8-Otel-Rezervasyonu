    ...
    <div class="wrap">
        ...
        <div id="hotel-facilities">
            <div class="container">
                ...
                <div id="tabs">
                    <nav class="tabs-nav">
                        <a href="{{asset('assets')}}/#" class="active" data-tab="tab1">
                            <i class="flaticon-restaurant icon"></i>
                            <span>Restaurant</span>
                        </a>
                        <a href="{{asset('assets')}}/#" data-tab="tab2">
                            <i class="flaticon-cup icon"></i>
                            <span>Bar</span>
                        </a>
                        <a href="{{asset('assets')}}/#" data-tab="tab3">

                            <i class="flaticon-car icon"></i>
                            <span>Pick-up</span>
                        </a>
                        <a href="{{asset('assets')}}/#" data-tab="tab4">

                            <i class="flaticon-swimming icon"></i>
                            <span>Swimming Pool</span>
                        </a>
                        <a href="{{asset('assets')}}/#" data-tab="tab5">

                            <i class="flaticon-massage icon"></i>
                            <span>Spa</span>
                        </a>
                        <a href="{{asset('assets')}}/#" data-tab="tab6">
